...
class ConfigurationReader {
  Future<bool> pubspecFileExist(String inputPath) async {
    final pubspecFilePath = path.join(inputPath, 'pubspec.yaml');
  ...
  Future<bool> architectureFileExist(String inputPath, String configurationFileName) async {
    final architectureFilePath = path.join(inputPath, configurationFileName);
  ...
  Future<ProjectConfiguration> readConfiguration(String input, String architectureConfigFileName) async {
    final architectureFilePath = path.join(input, architectureConfigFileName);
